...
mask = [True,False,False,True,True,True,True,True,True,True,True]
X_new = X[:,mask]
#N,M = np.shape(X_new)
...
figure(1)
bar(range(20),density[2:22])
title('Gaussian density estimate')
show()
print('GausKernel. The index of the lowest density object:\n {},\n score:\n {} '.format(i[:10],np.round(density[i[0:10]],4)))
...
show()
print('KNN density. The index of the lowest density object:\n {},\n score:\n {} '.format(i[:10],np.round(density[i[0:10]],4)))
...
show()
print('The index of the lowest density object:\n {},\n score:\n {} '.format(i_avg_rel[:10],np.round(avg_rel_density[:10],4)))
...
show()
print('The index of the lowest density object:\n {},\n score:\n {} '.format(i[:10],np.round(score[i[0:10]],4)))
